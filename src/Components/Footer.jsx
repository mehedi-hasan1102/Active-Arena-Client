...
//       dark:bg-gray-900 dark:text-blue-100 transition-colors duration-300
//       min-h-[180px]"
//     >
...
//           <Link
//             to="/"
//             className="flex items-center gap-2 text-2xl font-bold text-blue-700 dark:text-blue-300 mb-4"
//           >
...
//             Contact
//           </h3>
//           <p className="text-sm">Email: help@assignment12.com</p>
//           <p className="text-sm mb-3">Phone: +880 1700-123456</p>

//           <div className="flex gap-4 mt-2">
//             <a
//               href="https://facebook.com/assignment12"
//               target="_blank"
...
//             </a>
//             <a
//               href="https://instagram.com/assignment12"
//               target="_blank"
//               rel="noopener noreferrer"
...
//             </a>
//             <a
//               href="https://twitter.com/assignment12"
//               target="_blank"
//               rel="noopener noreferrer"
//               aria-label="Twitter"
//               className="text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 text-xl transition-transform hover:scale-110"
...
//         &copy; {new Date().getFullYear()} assignment 12 — All rights reserved.
//       </div>
//     </footer>
//   );
// };
