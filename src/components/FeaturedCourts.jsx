              ...
              <div className="relative h-full bg-white dark:bg-zinc-800 p-6 rounded-xl border border-gray-100 dark:border-zinc-700 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="flex gap-3">
                  <motion.button
                    ...
                    className="flex-1 bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-700 hover:to-cyan-700 text-white py-2 rounded-md font-medium transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    Book Now
                  </motion.button>
                  {/* <motion.button
