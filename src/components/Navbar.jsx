        ...
        <div className="lg:hidden px-4 pb-4 pt-2 bg-white dark:bg-zinc-900 border-t">
          ...
          {!user ? (
            <div className="mt-4 flex flex-col gap-2">
              <Link
                to="/login"
                className="block w-full text-center px-4 py-2 rounded-md bg-gradient-to-r from-cyan-500 to-emerald-500 text-white hover:from-cyan-600 hover:to-emerald-600"
              >
                Login
              </Link>
              <Link
                to="/signup"
                className="block w-full text-center px-4 py-2 rounded-md bg-gradient-to-r from-emerald-500 to-green-500 text-white hover:from-emerald-600 hover:to-green-600"
              >
                Sign Up
              </Link>
            </div>
