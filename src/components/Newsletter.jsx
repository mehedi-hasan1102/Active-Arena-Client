        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-700 hover:to-cyan-700 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-300"
            >
              Subscribe
            </motion.button>
          </motion.form>
