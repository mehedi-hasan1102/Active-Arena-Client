...
const PromotionsSection = () => {
  ...
  return (
    <section
      id="promotions"
      ref={ref}
      className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 py-20 transition-colors duration-300"
    >
            ...
            >
              ...
              <div className="relative bg-white dark:bg-zinc-800 rounded-xl p-6 flex flex-col items-center h-full border border-gray-100 dark:border-zinc-700 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="mt-6 w-full py-2 text-sm font-medium rounded-lg bg-gray-100 dark:bg-zinc-700 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-zinc-600 transition-colors duration-300"
                >
                  Copy Code
                </motion.button>
              </div>
