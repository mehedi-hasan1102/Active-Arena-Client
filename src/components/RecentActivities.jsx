...
//   return (
//     <section className="py-12 px-4 md:px-8 lg:px-16 bg-gradient-to-br from-purple-50 via-white to-purple-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 transition-colors duration-300">
//       <h2 className="text-3xl font-bold text-center mb-8 text-purple-700 dark:text-purple-400">📢 Recent Activity</h2>

//       <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
//         {recentActivities.map((activity) => (
//           <div
//             key={activity.id}
//             className="bg-white dark:bg-zinc-900 shadow-md dark:shadow-purple-800/20 rounded-md p-6 flex flex-col transition hover:scale-105"
//           >
//             <h3 className="text-lg font-semibold text-purple-700 dark:text-purple-400">{activity.user}</h3>
//             <p className="text-gray-800 dark:text-purple-200 mt-2">{activity.action}</p>
//             <span className="text-gray-500 dark:text-purple-300 mt-4 text-sm">{activity.time}</span>
//           </div>
//         ))}
//       </div>
//     </section>
