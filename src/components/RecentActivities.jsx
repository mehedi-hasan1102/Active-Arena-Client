...
const recentActivities = [
  { id: 1, user: 'Mehedi Hasan', action: 'Booked Court A', time: '2 hours ago', avatar: 'https://randomuser.me/api/portraits/men/32.jpg' },
  { id: 2, user: 'Sara Khan', action: 'Subscribed to Premium Plan', time: '5 hours ago', avatar: 'https://randomuser.me/api/portraits/women/44.jpg' },
  { id: 3, user: 'John Doe', action: 'Attended Tennis Event', time: '1 day ago', avatar: 'https://randomuser.me/api/portraits/men/22.jpg' },
  { id: 4, user: 'Alice Smith', action: 'Booked Court B', time: '2 days ago', avatar: 'https://randomuser.me/api/portraits/women/63.jpg' },
];
          ...
          {recentActivities.map((activity, index) => (
            <motion.div key={activity.id} variants={cardVariants} transition={{ delay: index * 0.1 }} className="relative group" whileHover={{ y: -5 }}>
              ...
              <div className="relative h-full bg-white/80 dark:bg-zinc-800/70 p-6 rounded-xl border border-gray-100 dark:border-zinc-700 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-800 dark:text-gray-200 mt-2 pl-1 border-l-4 border-emerald-400 dark:border-emerald-600">{activity.action}</p>
