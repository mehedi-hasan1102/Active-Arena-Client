...
const testimonials = [
  {
    name: 'John Doe',
    role: 'Professional Player',
    message: 'ActiveArena has the best courts and facilities I have ever used. The maintenance is top-notch and the booking system is seamless. Highly recommended!',
  ...
  },
  {
    name: 'Jane Smith',
    role: 'Member',
    message: 'Booking courts is super easy and the staff is really helpful. The mobile app makes it convenient to manage my schedule. Love it!',
  ...
  },
  {
    name: 'Ali Hasan',
    role: 'Amateur Player',
    message: 'Great experience and friendly environment. The coaching programs helped me improve my game significantly. Definitely coming back!',
            ...
            >
              ...
              <div className="relative h-full bg-white dark:bg-zinc-800 p-8 rounded-xl border border-gray-100 dark:border-zinc-700 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center">
                <img
                  ...
                  className="w-20 h-20 rounded-full mb-6 border-4 border-emerald-200 dark:border-emerald-800 object-cover"
                />
                ...
                <p className="text-gray-700 dark:text-gray-300 italic text-center mb-6">
                  "{testimonial.message}"
                </p>
                <div className="mt-auto text-center">
                  <h3 className="font-semibold text-lg text-emerald-700 dark:text-emerald-400 mb-1">
                    {testimonial.name}
                  </h3>
