...
import { auth } from "../../context/firebase/firebase.config";
import { motion as Motion } from "framer-motion";
import { useRole } from "../../hooks/useRole"; // import your custom role hook if any
...
const Overview = () => {
  ...
  const { role, isLoading: loadingRole } = useRole(); // get user role from your hook
  const [stats, setStats] = useState({ totalBookings: 0, myBookings: 0 });
  ...
  useEffect(() => {
    ...
    async function fetchBookings() {
      ...
      try {
        ...
        // data.bookings is the array from backend
